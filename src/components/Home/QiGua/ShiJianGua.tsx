...
import { Text, View, StyleSheet, ViewStyle, Dimensions, ScrollView } from 'react-native';
import { inject, observer } from 'mobx-react/native';
import { Button, DatePicker, Picker, List, Card } from 'antd-mobile-rn';
...
import ModalKit from '../../ModalKit/index';
...
@inject('store')
@observer
class ShiJianGua extends React.Component<
...
const guali = (
	<ScrollView>
		<View style={{ alignItems: 'center' }}>
			<Text style={{ fontSize: 22 }} selectable={true} >观梅占</Text>
		</View>
		...
		<View style={{ alignItems: 'center' }}>
			<Text style={{ fontSize: 22 }} selectable={true}>牡丹占</Text>
		</View>
		<Text style={{ fontSize: 18 }} selectable={true}>
		...
		<Text style={{ fontSize: 18 }} selectable={true}>断之曰：“巽木为体，乾金克之，互卦又见重乾，克体之卦多矣，卦中无生意，固知牡丹必为践毁。所谓马者，乾为马也。午时者，离明之象，是以知之也。”</Text>
	</ScrollView>
);
