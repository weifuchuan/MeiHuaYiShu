...
<body>
  ...
  <input id="thing">
  <h3>分析：</h3>
  <div class="editor" id="analysis">

  </div>
  <h3>断语：</h3>
  <div class="editor" id="assert">
...
//# sourceMappingURL=quill.min.js.map
  ...
  <script>
    window.onload = function () {
      var analysis = new Quill('#analysis', {
        modules: {
          toolbar: [
            [{ header: [1, 2, false] }],
      ...
      window.document.addEventListener('message', function (msg) {
        ...
        if (req.action === 'get'){
          window.postMessage(JSON.stringify({
            id:req.id, 
            thing:thing.value, 
            analysis:analysis.getContents(), 
            assert:assert.getContents(), 
          }))
        }
      })
    }
